...
@section('content')
    <div class="header-bg"  style="border: 1px solid black;">
    </div><!-- slider -->
                        ...
                        <div class="blog-post-inner">
                            ...
                            <div class="post-info">
                                ...
                                <div class="middle-area">
                                    <a class="name" href="{{route('author.profile', $post->user->name)}}"><b>{{ $post->user->name }}</b></a>
    ...
    <section class="recomended-area section"   style="background-color: gray;">
        <div class="container">
            <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card h-100">
                            <div class="single-post post-style-1">
                                ...
                                <div class="blog-info">
                                    <a href="{{route('author.profile', $randompost->user->name)}}" style="color: green;">{{$randompost->user->name}}</a>
                                    <h4 class="title"><a href="{{ route('post.details',$randompost->slug) }}" style="color: tomato;"><b>{{ $randompost->title }}</b></a></h4>
                            ...
                            <div class="commnets-area ">
                                ...
                                <div class="comment">
                                    ...
                                    <div class="post-info">
                                        ...
                                        <div class="middle-area">
                                            <a class="name" href="{{route('author.profile', $comment->user->name)}}"><b>{{ $comment->user->name }}</b></a>
